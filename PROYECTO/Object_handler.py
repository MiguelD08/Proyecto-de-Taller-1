...
class ObjectHandler:
    def __init__(self, game):
        ...
        self.sprite_list = []
        self.npc_list = []
        self.npc_sprite_path = 'Recursos/Sprites/NPC/'
        self.static_sprite_path = 'Recursos/Sprites/Static_sprites/'
        self.anim_sprite_path = 'Recursos/Sprites/Animated_sprites/'
